...
func AddownerHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/owners", cfg.BaseURL)
...
func CreateAddownerTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_owners",
		mcp.WithDescription("Adds a pet owner"),
