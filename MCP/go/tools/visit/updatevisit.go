...
func UpdatevisitHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateUpdatevisitTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_visits_visitId",
		mcp.WithDescription("Update a visit by ID"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    UpdatevisitHandler(cfg),
	}
}
