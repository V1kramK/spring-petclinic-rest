...
func GetpetHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateGetpetTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_pets_petId",
