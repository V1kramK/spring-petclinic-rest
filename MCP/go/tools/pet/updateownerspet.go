...
func UpdateownerspetHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateUpdateownerspetTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_owners_ownerId_pets_petId",
		mcp.WithDescription("Update a pet's details"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    UpdateownerspetHandler(cfg),
	}
}
