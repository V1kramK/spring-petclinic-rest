# Spring PetClinic MCP Server

This MCP (Model Content Protocol) server provides access to Spring PetClinic API functionality through HTTP, HTTPS, and STDIO transport modes.
