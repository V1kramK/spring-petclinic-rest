/**
 * MCP Server function for Update a pet by ID
 */
...
class Put_Pets_Pet_IdMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getPut_Pets_Pet_IdHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("visits")) {
            queryParams.add("visits=" + args.get("visits"));
        }
                
                String queryString = queryParams.isEmpty() ? "" : "?" + String.join("&", queryParams);
                String url = config.getBaseUrl() + "/api/v2/put_pets_pet_id" + queryString;
    ...
    public static MCPServer.Tool createPut_Pets_Pet_IdTool(MCPServer.APIConfig config) {
        Map<String, Object> parameters = new HashMap<>();
        parameters.put("type", "object");
        Map<String, Object> properties = new HashMap<>();
        Map<String, Object> birthDateProperty = new HashMap<>();
        birthDateProperty.put("type", "string");
        birthDateProperty.put("required", false);
        ...
        idProperty.put("description", "Input parameter: The ID of the pet.");
        properties.put("id", idProperty);
        Map<String, Object> ownerIdProperty = new HashMap<>();
        ownerIdProperty.put("type", "string");
        ownerIdProperty.put("required", false);
        ownerIdProperty.put("description", "Input parameter: The ID of the pet's owner.");
        ...
        Map<String, Object> visitsProperty = new HashMap<>();
        visitsProperty.put("type", "string");
        visitsProperty.put("required", false);
        visitsProperty.put("description", "Input parameter: Vet visit bookings for this pet.");
        properties.put("visits", visitsProperty);
        ...
        return new MCPServer.Tool(definition, getPut_Pets_Pet_IdHandler(config));
    }
