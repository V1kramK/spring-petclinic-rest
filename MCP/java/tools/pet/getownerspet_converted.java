/**
 * MCP Server function for Get a pet by ID
 */
...
class Get_Owners_Owner_Id_Pets_Pet_IdMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getGet_Owners_Owner_Id_Pets_Pet_IdHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("petId")) {
            queryParams.add("petId=" + args.get("petId"));
                ...
                String url = config.getBaseUrl() + "/api/v2/get_owners_owner_id_pets_pet_id" + queryString;
    ...
    public static MCPServer.Tool createGet_Owners_Owner_Id_Pets_Pet_IdTool(MCPServer.APIConfig config) {
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "get_owners_owner_id_pets_pet_id",
            "Get a pet by ID",
            parameters
        );
        
        return new MCPServer.Tool(definition, getGet_Owners_Owner_Id_Pets_Pet_IdHandler(config));
    }
